...
export const CHAPTERS: Chapter[] = [
  ...
  },
  {
    ...
    items: [
      ...
      {
        id: 'dig-5',
        title: 'Nalatenschapscontact instellen (Apple)',
        description: 'Wijs een vertrouwd persoon aan die na je overlijden bij je Apple-account kan.',
        urgency: 'medium',
        duration: '5 min',
        hasFlow: true,
        actionLabel: 'Uitleg bekijken',
      },
      {
        ...
        description: 'Regel wat er met je Google-account gebeurt als je het lang niet gebruikt.',
        urgency: 'medium',
        duration: '5 min',
        hasFlow: true,
        actionLabel: 'Uitleg bekijken',
